...
public class PayloadImpl extends MinimalEObjectImpl.Container implements Payload {
	 ...
	 * @ordered
	 */
	protected EList<MessageContent> content;
	 ...
	 * @generated
	 */
	public EList<MessageContent> getContent() {
		if (content == null) {
			content = new EObjectResolvingEList<MessageContent>(MessageContent.class, this, CHESSIoTSoftwarePackage.PAYLOAD__CONTENT);
		}
		return content;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CHESSIoTSoftwarePackage.PAYLOAD__CONTENT:
				getContent().clear();
				getContent().addAll((Collection<? extends MessageContent>)newValue);
				return;
		}
