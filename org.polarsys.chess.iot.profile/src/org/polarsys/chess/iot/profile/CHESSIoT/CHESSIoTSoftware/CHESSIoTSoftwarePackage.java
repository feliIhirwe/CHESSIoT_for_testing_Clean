...
public interface CHESSIoTSoftwarePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int VIRTUAL_BOARD__IO_TSTATE = 1;
	 ...
	 * @ordered
	 */
	int VIRTUAL_BOARD__BASE_COMPONENT = 2;
	 ...
	 * @ordered
	 */
	int VIRTUAL_BOARD_FEATURE_COUNT = 3;
	 ...
	 * @ordered
	 */
	int INCOMING_EVENT__RECEIVE = IO_TEVENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INCOMING_EVENT__INCOMING = IO_TEVENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RECEIVE_PAYLOAD__PAYLOAD = IO_TACTION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RECEIVE_PAYLOAD__PORT = IO_TACTION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MESSAGE_CONTENT__BASE_PROPERTY = 0;
	 ...
	 * @ordered
	 */
	int MESSAGE_CONTENT_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int SEND_PAYLOAD__PORT = IO_TACTION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int VIRTUAL_ENTITY_FEATURE_COUNT = SYSTEM_SW_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the reference list '{@link org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSoftware.Payload#getContent <em>Content</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference PAYLOAD__CONTENT = eINSTANCE.getPayload_Content();
